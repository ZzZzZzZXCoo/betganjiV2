    ...
    <div className="flex justify-center items-center min-h-[calc(100vh-200px)]">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">Welcome to BetGanji</CardTitle>
          <CardDescription>
            Sign in to access predictions and more
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
            <div className="bg-red-50 text-red-500 p-3 rounded-md mb-4 text-sm">
              {error === 'OAuthSignin' && 'Error starting the OAuth sign in process.'}
              {error === 'OAuthCallback' && 'Error completing the OAuth sign in process.'}
              ...
              {error === 'OAuthAccountNotLinked' && 'Email on the account already exists with a different provider.'}
